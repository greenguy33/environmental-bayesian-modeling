...
data = pd.read_csv("data/ortiz-bobea-dataset-train.csv")
...
with open ('models/ortiz-bobea-reproduction-year-country-fixed-effects-deterministic-observed-withheld.pkl', 'wb') as buff:
    pkl.dump({
        "prior":prior,
        "trace":trace,
        "posterior":posterior
