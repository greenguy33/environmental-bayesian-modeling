...
data = pd.read_csv("data/burke-dataset-integrated.csv")
...
with open ('models/burke-reproduction-mcmc-fixed-effects-grad-effects-deterministic-observed-missing-rows-imputed.pkl', 'wb') as buff:
  pkl.dump({
      "prior":prior,
      "trace":trace,
      "posterior":posterior,
