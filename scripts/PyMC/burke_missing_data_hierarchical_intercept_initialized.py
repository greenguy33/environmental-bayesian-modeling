...
with pm.Model() as model:
    ...
    # make first year reference category
...
with open ('models/burke-reproduction-mcmc-fixed-effects-grad-effects-missing-rows-imputed-hierarchical-country-priors-intercept-initialized.pkl', 'wb') as buff:
  pkl.dump({
      "prior":prior,
      "trace":trace,
      "posterior":posterior,
